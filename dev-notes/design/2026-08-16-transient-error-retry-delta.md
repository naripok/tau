# Delta: Automatic retry of transient provider errors

## Domain: Transient provider error retry

No living spec exists for this domain (`docs/specs/` does not exist). Every
requirement of the feature spec (`dev-notes/design/2026-08-16-transient-error-retry-spec.md`)
is ADDED verbatim below. The sync step in finishing will create the living spec
from this delta.
